import decoradores.CamaraEnVivoDecorator;
...
public class CamaraEnVivoDecoratorTest {
	private ServicioAbstracto servicioBase;
	private CamaraEnVivoDecorator decorador;
	...
	@Test
	@DisplayName("TC05: calcularPrecio con periodo null propaga excepción")
	...
	@Test
	@DisplayName("TC06: calcularPrecio con pricing null propaga excepción")
	...
	@Test
	@DisplayName("TC07: calcularPrecio cuando el precio base es cero retorna 15 USD")
	void testCalcularPrecioBaseCero() {
		...
		CamaraEnVivoDecorator decoCero = new CamaraEnVivoDecorator(servicioCero);
		Money resultado = decoCero.calcularPrecio(periodo, List.of("juegos"), pricing);
		assertEquals(Money.usd(15), resultado);
		assertTrue(resultado.esIgualA(Money.usd(15)));
	}
}
