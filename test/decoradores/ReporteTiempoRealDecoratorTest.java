import decoradores.ReporteTiempoRealDecorator;
...
public class ReporteTiempoRealDecoratorTest {
	private ServicioAbstracto servicioBase;
	private ReporteTiempoRealDecorator decorador;
	...
	@Test
	@DisplayName("TC05: calcularPrecio cuando el precio base es cero retorna 20 USD")
	void testCalcularPrecioBaseCero() {
		...
		ReporteTiempoRealDecorator decoCero = new ReporteTiempoRealDecorator(servicioCero);
		Money resultado = decoCero.calcularPrecio(periodo, List.of("juegos"), pricing);
		assertEquals(Money.usd(20), resultado);
		assertTrue(resultado.esIgualA(Money.usd(20)));
	}
}
